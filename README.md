...
- **單人** 選經典難度：A 初級 9×9／10 雷、B 中級 16×16／40 雷、C 高級 30×16／99 雷。第一格保證安全。左鍵揭開，右鍵或長按插旗。
- **雙人競賽** 固定高級 C，最多 2 人、無電腦。開局用同一種子佈雷，雙方棋盤完全相同。**第一格不保證安全。** 先揭完所有安全格者勝；踩雷即出局，對手若仍在場即獲勝。幾乎同時的操作以伺服器先處理的為準。對局中斷線視為棄權。
